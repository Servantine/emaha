                ...
                <form action="/mahasiswa/update/{{ $mhs->id }}" method="POST">
                  ...
                  @method('PUT')
                    ...
                    <div class="form-group">
                      ...
                      <label>Minat</label>
                    <div class="form-check">
                      <input type="checkbox" name="minat[]" value="ai" {{ in_array('ai', $minat) ? 'checked':'' }} class="form-check-input">
                      <label>Artificial Intelegent</label>
                    </div>
                    <div class="form-check">
                      <input type="checkbox" name="minat[]" value="web" {{ in_array('web', $minat) ? 'checked':'' }} class="form-check-input">
                      <label>Web Engineering</label>
                    </div>
                    <div class="form-check">
                      <input type="checkbox" name="minat[]" value="dbms" {{ in_array('dbms', $minat) ? 'checked':'' }} class="form-check-input">
